...
import { Clock, Users, TrendingUp, Award, ChevronLeft, ChevronRight, Video, CheckCircle, Star, X } from 'lucide-react';
import ReviewModal from './ReviewModal';
import MeetingNotification from './MeetingNotification';
import { formatMessageTime, formatFullDateTime } from '../../utils/timezone';
  ...
  useEffect(() => {
    if (socket) {
      socket.on('meetingCreated', (data) => {
        ...
        // Show notification popup (only for learners)
        if (data.learnerId && data.learnerId === user._id) {
